...
export default function Home() {
  ...
  return (
    <div className="w-full font-sans bg-brand-cream overflow-x-hidden relative">
      ...
      {/* Hero Section */}
      <section 
        className="relative h-[100dvh] flex flex-col justify-center items-center bg-brand-dark overflow-hidden pt-16"
      >
        {/* Full Background Image */}
        <div 
          className="absolute inset-0 bg-cover bg-center z-0"
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1589302168068-964664d93dc0?q=80&w=1920&auto=format&fit=crop')` }}
        />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          ...
          <div className="absolute inset-0 opacity-[0.1] bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')]" />
        </div>

        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex justify-center items-center text-center">
          ...
          >
            <motion.span 
              ...
              className="block text-xl md:text-3xl font-serif italic text-white mb-4 drop-shadow-md"
            >
              Experience
            </motion.span>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-extrabold text-[#c9a34e] leading-[1.1] mb-6 drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)] glowing-text">
              Pure Vegetarian <br />
              Luxury
            </h1>
            <div className="h-[2px] w-40 md:w-64 bg-gradient-to-r from-transparent via-[#c9a34e] to-transparent mb-6"></div>
            <p className="text-xl md:text-3xl font-serif italic text-white mb-6 max-w-2xl leading-relaxed drop-shadow-md">
            ...
            >
              <Link
                to="/menu"
                className="inline-block bg-gradient-to-b from-[#d4af37] via-[#c9a34e] to-[#b8860b] text-[#1f3d2b] px-12 py-4 md:px-16 md:py-5 rounded-full text-lg md:text-xl font-bold tracking-widest shadow-[0_10px_25px_rgba(0,0,0,0.5)] hover:shadow-[0_15px_35px_rgba(201,163,78,0.5)] transition-all duration-300 border border-[#f8f6f1]/30"
              >
                View Menu
              </Link>
            </motion.div>
