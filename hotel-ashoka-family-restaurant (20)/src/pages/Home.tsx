...
export default function Home() {
  ...
  return (
    <div className="w-full font-sans bg-brand-cream overflow-x-hidden relative">
      ...
      {/* Hero Section */}
      <section 
        className="relative h-[100dvh] max-h-[900px] flex items-center bg-brand-dark overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center lg:h-auto">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-extrabold text-[#c9a34e] leading-[1.1] mb-6 drop-shadow-sm glowing-text">
                Pure Vegetarian <br />
                Luxury
              </h1>
              <div className="h-[2px] w-32 bg-gradient-to-r from-[#c9a34e] to-transparent mb-6"></div>
              <p className="text-xl md:text-2xl font-serif italic text-white mb-8 max-w-lg leading-relaxed">
