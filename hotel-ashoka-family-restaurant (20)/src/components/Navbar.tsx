    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex justify-between items-center py-3 lg:py-4">
          {/* Logo */}
          <AnimatedRouterLink to="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-brand-cream/10 rounded-full border border-[#c9a34e]/30 group-hover:scale-110 transition-transform duration-500 overflow-hidden shrink-0">
              <img 
            ...
            <span className="font-serif text-2xl md:text-4xl font-bold text-[#c9a34e] tracking-tight italic group-hover:scale-105 transition-transform duration-300 flex items-center shrink-0" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
              Hotel Ashoka
            </span>
          </AnimatedRouterLink>
