        ...
        >
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="lg:col-span-1 h-48 lg:h-auto rounded-3xl overflow-hidden glass-panel relative border border-brand-dark/10 group hover:-translate-y-2 transition-all duration-300">
            ...
            <img 
              ...
              alt="Map" 
              className="absolute inset-0 w-full h-full object-cover opacity-30 grayscale mix-blend-multiply group-hover:scale-110 transition-transform duration-700"
            />
            ...
            >
              <div className="bg-brand-cream/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-brand-yellow/30 flex items-center gap-3 group-hover:bg-brand-cream transition-colors duration-300">
                <MapPin className="w-5 h-5 text-brand-dark" />
                <span className="text-brand-dark font-semibold">Hotel Ashoka</span>
              </div>
            </AnimatedLink>
          </motion.div>
