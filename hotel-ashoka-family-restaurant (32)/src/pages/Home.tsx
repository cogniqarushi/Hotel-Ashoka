...
export default function Home() {
  ...
  return (
    <div className="w-full font-sans bg-brand-cream overflow-x-hidden relative">
      ...
      {/* Hero Section */}
      <section 
        className="relative min-h-[100dvh] lg:min-h-0 lg:h-[100dvh] lg:max-h-[900px] flex items-center bg-brand-dark overflow-hidden"
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div 
            className="absolute inset-0 lg:hidden opacity-40 bg-[url('https://images.unsplash.com/photo-1589302168068-964664d93dc0?q=80&w=1200&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat"
          />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center lg:h-auto">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-extrabold text-[#c9a34e] leading-[1.1] mb-6 drop-shadow-md glowing-text">
                Pure Vegetarian <br />
                Luxury
              </h1>
              <div className="h-[2px] w-24 lg:w-32 bg-gradient-to-r from-transparent via-[#c9a34e] to-transparent lg:from-[#c9a34e] lg:to-transparent mb-6 mx-auto lg:mx-0"></div>
              <p className="text-xl md:text-2xl font-serif italic text-white mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed drop-shadow-md">
              ...
              >
                <Link
                  to="/menu"
                  className="inline-block bg-gradient-to-b from-[#d4af37] via-[#c9a34e] to-[#b8860b] text-[#1f3d2b] px-10 py-3 md:px-12 md:py-4 rounded-full text-lg font-bold tracking-widest shadow-[0_10px_20px_rgba(201,163,78,0.3)] hover:shadow-[0_15px_30px_rgba(201,163,78,0.5)] transition-all duration-300 border border-[#f8f6f1]/20"
                >
                  View Menu
                </Link>
              </motion.div>
            ...
            <div className="relative hidden lg:flex h-[400px] lg:h-[500px] xl:h-[600px] items-center justify-center">
      ...
      {/* Gallery Section */}
      <section className="py-20" style={{ perspective: "1500px" }}>
