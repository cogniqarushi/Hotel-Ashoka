...
const features = [
  ...
  },
  {
    ...
    items: ["Kids playing area", "Parking"]
  },
  {
    title: "Atmosphere",
  ...
  },
  {
    ...
    items: ["Brunch reservations recommended", "Accepts reservations", "Family Celebrations like birthday parties and small events"]
  },
  {
    title: "Payments",
    icon: <CreditCard className="w-6 h-6" />,
    items: ["Credit cards", "Debit cards", "UPI Payments"]
  },
  {
    title: "Children",
  ...
  },
  {
    ...
    items: ["Paid parking lot", "Plenty of parking"]
  }
];
    ...
    <div className="min-h-screen bg-brand-cream relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <img 
          src="https://png.pngtree.com/png-clipart/20220804/ourmid/pngtree-aesthetic-paper-notes-png-image_6098989.png"
          alt=""
          className="absolute -right-20 top-[800px] w-[500px] h-[500px] opacity-15 pointer-events-none object-contain mix-blend-multiply grayscale brightness-[1.05] contrast-[1.1] -rotate-12"
          referrerPolicy="no-referrer"
        />
      </div>
      {/* Hero Section */}
